        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
             ...
             <h3 className="line-break">k8VmMdR</h3>
             <iframe title="How To Use Discord" width="560" height="315" src="https://www.youtube.com/embed/rILeDVyeGO4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </section>
